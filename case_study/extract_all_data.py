...
Input:
  ...
  - hiv_pr_real_data/final_dataset.json (selection config)
...
def main():
    print("=" * 60)
    print("Real HIV-1 PR Data Extraction - ALL COMPLEXES")
    print("=" * 60)
    ...
    with open('/root/protein_ligand/MMDCG-DTA/MMDCG-DTA-main/case_study/hiv_pr_real_data/final_dataset.json') as f:
        all_entries = json.load(f)

    print(f"\nProcessing {len(all_entries)} selected complexes...\n")
